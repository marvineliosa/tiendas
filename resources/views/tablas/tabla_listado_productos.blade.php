  	...
  	@foreach($productos as $producto)
  		<tr>
  			...
  			<td>
	  			...
	  			<button type="button" class="btn btn-default btn-xs" onclick="ModalAgregarNotaVenta({!! $producto->PRODUCTOS_ID !!})">
  				  <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
  				</button>
          <button type="button" class="btn btn-default btn-xs" onclick="verCodigoBarras({!! $producto->PRODUCTOS_ID !!})">
            <span class="glyphicon glyphicon-barcode" aria-hidden="true"></span>
          </button>
          <button type="button" class="btn btn-default btn-xs" onclick="ModalVerHistorial({!! $producto->PRODUCTOS_ID !!})">
